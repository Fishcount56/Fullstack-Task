        ...
        <div>
            ...
            <div className={styleCSS.contentaddform}>
                ...
                <form className={styleCSS.addform} onSubmit={handleSubmit}>
                        ...
                        <input type="file" name="bookFile" className="form-control" id="bookFile" onChange={handleChange} />
                        {/* <input type="file" name="bookCover" className="form-control" id="bookFile" onChange={handleChange} /> */}
